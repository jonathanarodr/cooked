...
public class RecipeFactory implements RemoteViewsService.RemoteViewsFactory {
    ...
    public RemoteViews getViewAt(int position) {
        ...
        views.setTextViewText(R.id.tv_recipe_name_widget, mRecipes.get(position).getName());

        Bundle bundle = new Bundle();
        bundle.putParcelable(Intent.EXTRA_INTENT, mRecipes.get(position));
        views.setOnClickFillInIntent(R.id.tv_recipe_name_widget, new Intent().putExtras(bundle));
